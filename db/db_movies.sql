...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 02, 2018 at 05:55 PM
...
-- Database: `db_coup`
--
CREATE DATABASE IF NOT EXISTS `db_coup` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_coup`;
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_level`, `user_ip`, `user_firstlogin`) VALUES
(3, 'Jennifer', 'jeni', '1991', 'j@j.com', '2018-03-02 14:52:23', 1, '::1', 'no');
--
-- Database: `db_portfolio`
--
CREATE DATABASE IF NOT EXISTS `db_portfolio` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `db_portfolio`;
...
CREATE TABLE IF NOT EXISTS `tbl_portfolio` (
  ...
  `portfolio_info` longtext NOT NULL,
...
INSERT INTO `tbl_portfolio` (`portfolio_id`, `portfolio_img`, `portfolio_info`) VALUES
(1, 'port1.jpg', 'This was a business card designed for a local elementary school teacher to hand out on a magnet for supply teaching.'),
(2, 'port2.jpg', 'A gift certificate for a local lash business.'),
(3, 'port3.jpg', 'Taken in Port Stanley, Ontario on a Nikon D7000.'),
(4, 'port4.jpg', 'Photo taken in Point Clark Ontario on a Nikon D7000.'),
(5, 'port5.jpg', 'Mobile mockup for a local shoe company for a class assignment.'),
(6, 'port6.jpg', 'Business card mockup for an agency school assignment.');
COMMIT;
